    ...
    \begin{enumerate} [label=\textbf{4.2.\arabic*.}, wide, labelwidth=!, labelindent=0pt]
        ...
        \begin{enumerate}[label=\textbf{4.2.1.\arabic*.}, wide, labelwidth=!, labelindent=0pt]
            ...
            \begin{enumerate}[label=\arabic*.]
                ...
                \noindent Deskripsi	: Activity Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat list ticket oleh internal user dengan role developer yang ditunjukkan pada gambar \ref{fig:AD-DEV-01}.
            ...
            \begin{enumerate}[label=\arabic*.]
                ...
                \noindent Deskripsi	: Activity Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat list ticket oleh seorang external user yang ditunjukkan pada gambar \ref{fig:AD-PIC-01}.
                ...
                \noindent Deskripsi	: Activity Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat detail ticket oleh seorang external user yang ditunjukkan pada gambar \ref{fig:AD-PIC-04}.
                ...
                \noindent Deskripsi	: Activity Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk berkomunikasi dengan Product Manager oleh seorang external user yang ditunjukkan pada gambar \ref{fig:AD-PIC-07}.
        ...
        \begin{enumerate}[label=\textbf{4.2.2.\arabic*.}, wide, labelwidth=!, labelindent=0pt]
            ...
            \begin{enumerate}[label=\arabic*.]
                ...
                \noindent ID Sequence	: SQ-PM-01
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat list ticket oleh seorang internal user dengan role product manager. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.21:
                
                \begin{exenumerate}
                    \item Class Boundary : TicketPage
                    \item Class Control : TicketController
                    \item Class Entity : User, Employee, Ticket, Ticket Member, Product Member, Ticket Category, Ticket Status, Ticket Priority
                \end{exenumerate}
            
                
                \item Sequence Diagram Memfilter List Ticket
                
                \noindent ID Sequence	: SQ-PM-02
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk memfilter ticket oleh seorang internal user dengan role product manager. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.22:
                ...
                \noindent ID Sequence	: SQ-PM-03
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat detail ticket oleh seorang internal user dengan role product manager. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.23:
                
                \begin{exenumerate}
                    \item Class Boundary : TicketPage
                    \item Class Control : TicketController
                    \item Class Entity : Ticket
                \end{exenumerate}
                ...
                \begin{exenumerate}
                    \item Class Boundary : TicketPage
                    \item Class Control : TicketController
                    \item Class Entity : Ticket, ProductMember, TicketMember  
                \end{exenumerate}
            ...
            \begin{enumerate}[label=\arabic*.]
                ...
                \noindent ID Sequence	: SQ-DEV-01
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat list ticket oleh internal user dengan role developer. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.29:
            ...
            \begin{enumerate}[label=\arabic*.]
                ...
                \noindent ID Sequence	: SQ-PIC-01
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk melihat list ticket oleh seorang external user. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.33:
                ...
                \noindent ID Sequence	: SQ-PIC-02
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk memfilter ticket oleh seorang external user. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.34:
                ...
                \noindent ID Sequence	: SQ-PIC-03
                
                \noindent Deskripsi	: Sequence Diagram berikut merupakan sebuah proses aktivitas yang dilakukan untuk membuat ticket oleh seorang external user. Berikut merupakan class class yang ada pada sequence diagram yang ditunjukkan pada gambar 4.35:
