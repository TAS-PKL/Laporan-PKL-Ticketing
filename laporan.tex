...
\begin{enumerate}[label=\textbf{5.\arabic*.}]
    ...
    \begin{enumerate}[label=\textbf{5.1.\arabic*.}]
        ...
        Berikut merupakan sebagian fungsi yang diimplementasikan di backend menggunakan PHP dengan framework Laravel. Pengimplementasian kode menggunakan gaya campuran antara ORM Eloquent dan query builder.
